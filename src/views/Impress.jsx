    ...
    return (
        <>
            <Card className={classes.root}>
                ...
                <CardActions>
                    <Button component="a" href="mailto:searchzone@pascalchristen.ch" size="small">
                        Contact Me
                    </Button>
                </CardActions>
            </Card>
            <Card className={classes.root}>
                <CardContent>
                    ...
                    <Typography className={classes.pos} color="textSecondary">
                        ...
                        Website gehören ausschliesslich Pascal Christen oder den speziell genannten Rechtsinhabern. Für
                        die Reproduktion jeglicher Elemente ist die schriftliche Zustimmung der Urheberrechtsträger im
                        Voraus einzuholen.
                    </Typography>
                </CardContent>
                <CardActions>
                    <Button component="a" href="https://webkoenig.ch" size="small">
                        Quelle
                    </Button>
                </CardActions>
            </Card>
