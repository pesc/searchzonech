                ...
                <Toolbar className={classes.toolbar}>
                    <Grid container direction="row" justify="space-between" alignItems="center">
                        <Grid item xs={12} md={4}>
                            <Button onClick={() => navigate('/')} aria-label=".ch Search Engine'" color="inherit">
                            ...
                            <Hidden only={['md', 'sm', 'xs']}>
                                <Grid container direction="row" justify="flex-end" alignItems="center">
                                    <Grid item>
                                        ...
                                        <IconButton
                                            onClick={() => navigate('/impress')}
                                            aria-label="About searchzone.ch"
                                            color="inherit"
                                        >
                                            <Info fontSize="small" />
                                        </IconButton>
                                        <IconButton
                                            onClick={() =>
                                                window.open('https://github.com/pesc/searchzonech', '_blank')
                                            }
                                        ...
                                        <IconButton
                                            onClick={() => window.open('https://www.buymeacoffee.com/pesc', '_blank')}
                                            aria-label="Support"
                                            color="secondary"
                                        >
